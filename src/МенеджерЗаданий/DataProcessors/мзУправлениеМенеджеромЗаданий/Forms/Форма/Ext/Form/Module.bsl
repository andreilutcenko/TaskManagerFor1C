...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	АлгоритмПланировщика = Константы.мзАлгоритмПланировщика.Получить();
	Если Не ЗначениеЗаполнено(АлгоритмПланировщика) Тогда
		АлгоритмПланировщика = Перечисления.мзАлгоритмПланировщика.ОдноЗаданиеНаОбработчик;
		АлгоритмПланировщикаПриИзмененииНаСервере();
	КонецЕсли;
...
Процедура ОбновитьДанныеПоИсполнителямИЗаданиям()
	...
	КоличествоЗаданийВОчереди = мзЗадания.ПолучитьКоличествоЗаданийВОчереди();
...
&НаСервере
Процедура АлгоритмПланировщикаПриИзмененииНаСервере()
	
	мзЗадания.УстановитьАлгоритмПланировщика(АлгоритмПланировщика);
	
КонецПроцедуры

&НаКлиенте
Процедура АлгоритмПланировщикаПриИзменении(Элемент)
	АлгоритмПланировщикаПриИзмененииНаСервере();
КонецПроцедуры
